...
const MainBody = () => {
  ...
  return(
    <div className='flex max-md:flex-col lg:pl-2 w-screen font-p'>
      <div className='absolute top-0 left-0 z-10 border-b-2 border-black w-screen h-55 max-sm:h-50'></div>
      <div className='flex-1 max-lg:flex-0 h-dvh' />
      <div className='flex-3 h-dvh pt-30 max-lg:pl-2'>
        <h1 className='relative -left-2 text-8xl max-sm:text-7xl mb-5 text-gray-400 tracking-widest font-light font-main-heading'>Martin</h1>
        ...
        <TextSection title='About'>Hello! <br />I'm Martin. In my free time I like to read books, enhance my programming skills and go to the gym.<br />My philosophy is that working hard all the time gives you the most enjoyment in life, so that's what I strive to do.</TextSection>
        <TextSection title='Expirience'>I work on both back and front end. Some of the technologies I use in my web projects are <Hyperlink src='https://react.dev/'>React</Hyperlink>, <Hyperlink src='https://tailwindcss.com/'>TailwindCSS</Hyperlink>, <Hyperlink src='https://ui.shadcn.com/'>shadcn ui</Hyperlink> and <Hyperlink src='https://nginx.org/'>nginx</Hyperlink>.<br /> I like to poke around at C++ game development as well using <Hyperlink src='https://www.opengl.org/'>OpenGL</Hyperlink>.</TextSection>
      </div>
      <div className='flex-2 max-md:flex-1 max-sm:w-dvw flex flex-col h-dvh min-h-dvh bg-linear-to-br from-white to-blue-400'>
      </div>
