  ...
  return(
    <div className='flex max-md:flex-col w-full font-p'>
      ...
      <div className='flex-3 h-dvh pt-30 max-lg:pl-2'>
        <h1 className='relative -left-2 text-8xl max-sm:text-7xl mb-5 to-blue-950 tracking-widest font-light font-main-heading select-none'>Martin</h1>
        <p className='text-xl font-bold'>I learn and use any technologies to create what I'm passionate for.</p>
        <p className='text-xl mb-5'>I'm currently a second year software engeneering student @ <Hyperlink src='https://finki.ukim.mk/en/'>FINKI</Hyperlink>, Skopje MK.</p>
        <div className='flex gap-4 items-center justify-start justify-items-evenly mb-5 w-auto h-10'>
          <a href='https://github.com/geck0h' target='_blank'rel='noopener noreferrer'><FaGithub className='transition-all ease h-10 w-10 hover:scale-110 text-blue-400 hover:text-blue-600' /></a>
          <CopyMailButton />
          <a href='https://github.com/geck0h' target='blank' rel='noopener noreferrer'><FaLinkedin className='transition-all ease h-10 w-10 hover:scale-110 text-blue-400 hover:text-blue-600' /></a>
        </div>
      ...
      <div className='flex-2 max-md:flex-1 max-sm:w-full flex flex-col h-100vh min-h-dvh bg-linear-to-br from-white to-blue-400'>
      </div>
